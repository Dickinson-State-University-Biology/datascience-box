...
knitr::include_graphics("https://dickinsonstatenews.com/wp-content/uploads/2020/01/2020-Buster-Thumbs-up-ARTICLE.jpg")
```
...
library(knitr)
style_duo_accent(
  primary_color = "#132e52",
  secondary_color = "#bfbfbf",
  inverse_header_color = "#2f5773"
)
style_mono_light(
...
- **Best:** Write a **rep**roducible **ex**ample (reprex) -- I'll introduce this concept more formally and teach you the tools for it a little later in the semester
]
--
.pull-right[
